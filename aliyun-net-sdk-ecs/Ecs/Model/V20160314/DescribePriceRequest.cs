...
namespace Aliyun.Acs.Ecs.Model.V20160314
{
    public class DescribePriceRequest : RpcAcsRequest<DescribePriceResponse>
    {
        public DescribePriceRequest()
            : base("Ecs", "2016-03-14", "DescribePrice", "ecs", "openAPI")
        {
		...
		public bool? NeedSpotPrice
		{
			...
			{
				needSpotPrice = value;
				DictionaryUtil.Add(QueryParameters, "NeedSpotPrice", value.ToString());
			}
		}
