...
{
    public class InnerEcsQueryByIpRequest : RpcAcsRequest<InnerEcsQueryByIpResponse>
    {
        public InnerEcsQueryByIpRequest()
            : base("Ecs", "2016-03-14", "InnerEcsQueryByIp", "ecs", "openAPI")
        {
        ...
        public override InnerEcsQueryByIpResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerEcsQueryByIpResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
