...
{
    public class ServiceMigrateToUnifyRequest : RpcAcsRequest<ServiceMigrateToUnifyResponse>
    {
        public ServiceMigrateToUnifyRequest()
            : base("Iot", "2019-07-30", "ServiceMigrateToUnify", "Iot", "openAPI")
        {
        }
        ...
        public override ServiceMigrateToUnifyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ServiceMigrateToUnifyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
