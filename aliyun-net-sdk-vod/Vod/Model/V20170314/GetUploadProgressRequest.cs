...
{
    public class GetUploadProgressRequest : RpcAcsRequest<GetUploadProgressResponse>
    {
        public GetUploadProgressRequest()
            : base("vod", "2017-03-14", "GetUploadProgress", "vod", "openAPI")
        {
		...
		public string UploadInfoList
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "UploadInfoList", value);
			}
		}
		...
		public string UploadAddress
		{
			...
			{
				uploadAddress = value;
				DictionaryUtil.Add(QueryParameters, "UploadAddress", value);
			}
		}
        ...
        public override GetUploadProgressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetUploadProgressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
