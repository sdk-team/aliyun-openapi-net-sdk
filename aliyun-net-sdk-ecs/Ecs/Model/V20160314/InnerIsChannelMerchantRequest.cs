...
{
    public class InnerIsChannelMerchantRequest : RpcAcsRequest<InnerIsChannelMerchantResponse>
    {
        public InnerIsChannelMerchantRequest()
            : base("Ecs", "2016-03-14", "InnerIsChannelMerchant", "ecs", "openAPI")
        {
        ...
        public override InnerIsChannelMerchantResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerIsChannelMerchantResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
