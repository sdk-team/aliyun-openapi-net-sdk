...
{
    public class UpdateTranscodeTemplateRequest : RpcAcsRequest<UpdateTranscodeTemplateResponse>
    {
        public UpdateTranscodeTemplateRequest()
            : base("vod", "2017-03-14", "UpdateTranscodeTemplate", "vod", "openAPI")
        {
        ...
        public override UpdateTranscodeTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateTranscodeTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
