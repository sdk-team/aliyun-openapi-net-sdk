...
{
    public class InnerGroupQueryVmRequest : RpcAcsRequest<InnerGroupQueryVmResponse>
    {
        public InnerGroupQueryVmRequest()
            : base("Ecs", "2016-03-14", "InnerGroupQueryVm", "ecs", "openAPI")
        {
        ...
        public override InnerGroupQueryVmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerGroupQueryVmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
