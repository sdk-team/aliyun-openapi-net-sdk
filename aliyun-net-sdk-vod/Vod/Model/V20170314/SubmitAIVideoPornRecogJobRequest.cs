...
namespace Aliyun.Acs.vod.Model.V20170314
{
    public class SubmitAIVideoPornRecogJobRequest : RpcAcsRequest<SubmitAIVideoPornRecogJobResponse>
    {
        public SubmitAIVideoPornRecogJobRequest()
            : base("vod", "2017-03-14", "SubmitAIVideoPornRecogJob", "vod", "openAPI")
        {
        ...
        public override SubmitAIVideoPornRecogJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
