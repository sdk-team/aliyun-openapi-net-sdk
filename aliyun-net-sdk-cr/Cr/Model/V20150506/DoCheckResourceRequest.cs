...
{
    public class DoCheckResourceRequest : RpcAcsRequest<DoCheckResourceResponse>
    {
        public DoCheckResourceRequest()
            : base("cr", "2015-05-06", "DoCheckResource", "cr", "openAPI")
        {
        }
        ...
        public override DoCheckResourceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DoCheckResourceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
