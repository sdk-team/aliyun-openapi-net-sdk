...
{
    public class DoLogicalDeleteResourceRequest : RpcAcsRequest<DoLogicalDeleteResourceResponse>
    {
        public DoLogicalDeleteResourceRequest()
            : base("cr", "2015-05-06", "DoLogicalDeleteResource", "cr", "openAPI")
        {
        }
        ...
        public override DoLogicalDeleteResourceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DoLogicalDeleteResourceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
