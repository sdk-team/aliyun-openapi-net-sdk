...
{
    public class GetThirdPartPlayPolicyRequest : RpcAcsRequest<GetThirdPartPlayPolicyResponse>
    {
        public GetThirdPartPlayPolicyRequest()
            : base("vod", "2017-03-14", "GetThirdPartPlayPolicy", "vod", "openAPI")
        {
        ...
        public override GetThirdPartPlayPolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetThirdPartPlayPolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
