...
{
	public class CreateVpnGreTunnelResponse : AcsResponse
	{
		...
		private CreateVpnGreTunnel_HealthCheck healthCheck;
		...
		public CreateVpnGreTunnel_HealthCheck HealthCheck
		{
			get
			{
				return healthCheck;
		...
		public class CreateVpnGreTunnel_HealthCheck
		{
