...
{
    public class InnerSnapshotSecurityMountRequest : RpcAcsRequest<InnerSnapshotSecurityMountResponse>
    {
        public InnerSnapshotSecurityMountRequest()
            : base("Ecs", "2016-03-14", "InnerSnapshotSecurityMount", "ecs", "openAPI")
        {
        ...
        public override InnerSnapshotSecurityMountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerSnapshotSecurityMountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
