...
{
    public class UpdateAudioTemplateRequest : RpcAcsRequest<UpdateAudioTemplateResponse>
    {
        public UpdateAudioTemplateRequest()
            : base("vod", "2017-03-14", "UpdateAudioTemplate", "vod", "openAPI")
        {
        ...
        public override UpdateAudioTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateAudioTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
