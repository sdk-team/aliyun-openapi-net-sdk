...
{
    public class ModifyApiNameRequest : RoaAcsRequest<ModifyApiNameResponse>
    {
        public ModifyApiNameRequest()
            : base("Acs", "2015-01-01", "ModifyApiName", "12334", "openAPI")
        {
			UriPattern = "/modifyApiName";
        ...
        public override ModifyApiNameResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyApiNameResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
