...
{
    public class InnerMonitorDataDescribeInstanceRequest : RpcAcsRequest<InnerMonitorDataDescribeInstanceResponse>
    {
        public InnerMonitorDataDescribeInstanceRequest()
            : base("Ecs", "2016-03-14", "InnerMonitorDataDescribeInstance", "ecs", "openAPI")
        {
        ...
        public override InnerMonitorDataDescribeInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerMonitorDataDescribeInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
