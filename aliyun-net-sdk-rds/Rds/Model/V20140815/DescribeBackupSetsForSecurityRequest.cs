...
namespace Aliyun.Acs.Rds.Model.V20140815
{
    public class DescribeBackupSetsForSecurityRequest : RpcAcsRequest<DescribeBackupSetsForSecurityResponse>
    {
        public DescribeBackupSetsForSecurityRequest()
            : base("Rds", "2014-08-15", "DescribeBackupSetsForSecurity")
        {
        }
        ...
        public override DescribeBackupSetsForSecurityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
