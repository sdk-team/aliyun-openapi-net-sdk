...
{
    public class InnerInstanceEnableSLBFlowRequest : RpcAcsRequest<InnerInstanceEnableSLBFlowResponse>
    {
        public InnerInstanceEnableSLBFlowRequest()
            : base("Ecs", "2016-03-14", "InnerInstanceEnableSLBFlow", "ecs", "openAPI")
        {
        ...
        public override InnerInstanceEnableSLBFlowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerInstanceEnableSLBFlowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
