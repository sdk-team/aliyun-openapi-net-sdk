...
{
    public class InnerInstanceDetailRequest : RpcAcsRequest<InnerInstanceDetailResponse>
    {
        public InnerInstanceDetailRequest()
            : base("Ecs", "2016-03-14", "InnerInstanceDetail", "ecs", "openAPI")
        {
        ...
        public override InnerInstanceDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerInstanceDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
