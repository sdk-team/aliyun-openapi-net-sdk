...
{
	public class InnerEcsQueryByParamResponse : AcsResponse
	{
		...
		private List<InnerEcsQueryByParam_Item> data;

		private InnerEcsQueryByParam_ErrorCode errorCode;
		...
		public List<InnerEcsQueryByParam_Item> Data
		{
			get
			{
				return data;
		...
		public InnerEcsQueryByParam_ErrorCode ErrorCode
		{
			get
			{
				return errorCode;
		...
		public class InnerEcsQueryByParam_Item
		{
			...
			private InnerEcsQueryByParam_Region region;

			private InnerEcsQueryByParam_Iz iz;

			private InnerEcsQueryByParam_Zone zone;
			...
			public InnerEcsQueryByParam_Region Region
			{
				get
				{
					return region;
			...
			public InnerEcsQueryByParam_Iz Iz
			{
				get
				{
					return iz;
			...
			public InnerEcsQueryByParam_Zone Zone
			{
				get
				{
					return zone;
			...
			public class InnerEcsQueryByParam_Region
			{
				...
				private InnerEcsQueryByParam_Attributes attributes;
				...
				public InnerEcsQueryByParam_Attributes Attributes
				{
					get
					{
						return attributes;
				...
				public class InnerEcsQueryByParam_Attributes
				{
			...
			public class InnerEcsQueryByParam_Iz
			{
				...
				private List<InnerEcsQueryByParam_IzResourceModelItem> izResourceModel;
				...
				public List<InnerEcsQueryByParam_IzResourceModelItem> IzResourceModel
				{
					get
					{
				...
				public class InnerEcsQueryByParam_IzResourceModelItem
				{
			...
			public class InnerEcsQueryByParam_Zone
			{
		...
		public class InnerEcsQueryByParam_ErrorCode
		{
