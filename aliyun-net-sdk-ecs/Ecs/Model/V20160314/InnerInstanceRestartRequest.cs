...
{
    public class InnerInstanceRestartRequest : RpcAcsRequest<InnerInstanceRestartResponse>
    {
        public InnerInstanceRestartRequest()
            : base("Ecs", "2016-03-14", "InnerInstanceRestart", "ecs", "openAPI")
        {
		...
		public bool? Kill
		{
			...
			{
				kill = value;
				DictionaryUtil.Add(QueryParameters, "kill", value.ToString());
			}
		}
        ...
        public override InnerInstanceRestartResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerInstanceRestartResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
