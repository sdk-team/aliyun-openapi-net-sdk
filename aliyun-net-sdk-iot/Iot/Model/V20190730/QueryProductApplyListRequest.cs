...
namespace Aliyun.Acs.Iot.Model.V20190730
{
    public class QueryProductApplyListRequest : RpcAcsRequest<QueryProductApplyListResponse>
    {
        public QueryProductApplyListRequest()
            : base("Iot", "2019-07-30", "QueryProductApplyList")
        {
        }
        ...
        public override QueryProductApplyListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryProductApplyListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
