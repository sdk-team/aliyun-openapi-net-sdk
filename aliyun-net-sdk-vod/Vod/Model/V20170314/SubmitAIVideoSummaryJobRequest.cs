...
namespace Aliyun.Acs.vod.Model.V20170314
{
    public class SubmitAIVideoSummaryJobRequest : RpcAcsRequest<SubmitAIVideoSummaryJobResponse>
    {
        public SubmitAIVideoSummaryJobRequest()
            : base("vod", "2017-03-14", "SubmitAIVideoSummaryJob", "vod", "openAPI")
        {
        ...
        public override SubmitAIVideoSummaryJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
