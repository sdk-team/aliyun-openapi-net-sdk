...
namespace Aliyun.Acs.Iot.Model.V20190730
{
    public class ListPropertyPoolForTmallGenieRequest : RpcAcsRequest<ListPropertyPoolForTmallGenieResponse>
    {
        public ListPropertyPoolForTmallGenieRequest()
            : base("Iot", "2019-07-30", "ListPropertyPoolForTmallGenie")
        {
        }
        ...
        public override ListPropertyPoolForTmallGenieResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPropertyPoolForTmallGenieResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
