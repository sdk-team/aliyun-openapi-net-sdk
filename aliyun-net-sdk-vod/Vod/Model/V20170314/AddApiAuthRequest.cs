...
{
    public class AddApiAuthRequest : RpcAcsRequest<AddApiAuthResponse>
    {
        public AddApiAuthRequest()
            : base("vod", "2017-03-14", "AddApiAuth", "vod", "openAPI")
        {
        ...
        public override AddApiAuthResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddApiAuthResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
