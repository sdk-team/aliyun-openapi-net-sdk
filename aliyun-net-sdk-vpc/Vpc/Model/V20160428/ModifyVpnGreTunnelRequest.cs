...
{
    public class ModifyVpnGreTunnelRequest : RpcAcsRequest<ModifyVpnGreTunnelResponse>
    {
        public ModifyVpnGreTunnelRequest()
            : base("Vpc", "2016-04-28", "ModifyVpnGreTunnel")
        {
        }
        ...
        public override ModifyVpnGreTunnelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyVpnGreTunnelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
