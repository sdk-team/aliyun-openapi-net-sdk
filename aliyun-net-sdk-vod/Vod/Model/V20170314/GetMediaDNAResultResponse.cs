	...
	public class GetMediaDNAResultResponse : AcsResponse
	{
		...
		public class GetMediaDNAResult_DNAResult
		{
			...
			public class GetMediaDNAResult_VideoDNAItem
			{
				...
				private List<GetMediaDNAResult_FpShotSlicesItem> fpShotSlices;
				...
				public List<GetMediaDNAResult_FpShotSlicesItem> FpShotSlices
				{
					get
					{
						return fpShotSlices;
				...
				public class GetMediaDNAResult_FpShotSlicesItem
				{
