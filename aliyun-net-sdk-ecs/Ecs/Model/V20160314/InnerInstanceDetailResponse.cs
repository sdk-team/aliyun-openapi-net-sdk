...
{
	public class InnerInstanceDetailResponse : AcsResponse
	{

		private string requestId;

		private InnerInstanceDetail_ErrorCode errorCode;

		private InnerInstanceDetail_Data data;
		...
		public InnerInstanceDetail_ErrorCode ErrorCode
		{
			get
			{
				return errorCode;
		...
		public InnerInstanceDetail_Data Data
		{
			get
			{
				return data;
		...
		public class InnerInstanceDetail_ErrorCode
		{
		...
		public class InnerInstanceDetail_Data
		{
			...
			private List<InnerInstanceDetail_Group> groups;

			private InnerInstanceDetail_PublicIp publicIp;

			private InnerInstanceDetail_Img img;

			private InnerInstanceDetail_StatusNote statusNote;
			...
			public List<InnerInstanceDetail_Group> Groups
			{
				get
				{
					return groups;
			...
			public InnerInstanceDetail_PublicIp PublicIp
			{
				get
				{
					return publicIp;
			...
			public InnerInstanceDetail_Img Img
			{
				get
				{
					return img;
			...
			public InnerInstanceDetail_StatusNote StatusNote
			{
				get
				{
					return statusNote;
			...
			public class InnerInstanceDetail_Group
			{
				...
				private List<InnerInstanceDetail_Tag> tags;
				...
				public List<InnerInstanceDetail_Tag> Tags
				{
					get
					{
						return tags;
				...
				public class InnerInstanceDetail_Tag
				{
			...
			public class InnerInstanceDetail_PublicIp
			{
			...
			public class InnerInstanceDetail_Img
			{
				...
				private List<InnerInstanceDetail_Tag2> tags1;

				private InnerInstanceDetail_OsTypeModel osTypeModel;

				private InnerInstanceDetail_QuoteType quoteType;
				...
				public List<InnerInstanceDetail_Tag2> Tags1
				{
					get
					{
						return tags1;
				...
				public InnerInstanceDetail_OsTypeModel OsTypeModel
				{
					get
					{
						return osTypeModel;
				...
				public InnerInstanceDetail_QuoteType QuoteType
				{
					get
					{
						return quoteType;
				...
				public class InnerInstanceDetail_Tag2
				{
				...
				public class InnerInstanceDetail_OsTypeModel
				{
					...
					private InnerInstanceDetail_Kind kind;
					...
					public InnerInstanceDetail_Kind Kind
					{
						get
						{
							return kind;
					...
					public class InnerInstanceDetail_Kind
					{
				...
				public class InnerInstanceDetail_QuoteType
				{
			...
			public class InnerInstanceDetail_StatusNote
			{
