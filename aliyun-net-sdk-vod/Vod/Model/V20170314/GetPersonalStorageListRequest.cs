...
{
    public class GetPersonalStorageListRequest : RpcAcsRequest<GetPersonalStorageListResponse>
    {
        public GetPersonalStorageListRequest()
            : base("vod", "2017-03-14", "GetPersonalStorageList", "vod", "openAPI")
        {
        ...
        public override GetPersonalStorageListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPersonalStorageListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
