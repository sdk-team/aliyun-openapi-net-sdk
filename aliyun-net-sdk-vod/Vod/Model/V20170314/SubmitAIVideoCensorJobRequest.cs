...
namespace Aliyun.Acs.vod.Model.V20170314
{
    public class SubmitAIVideoCensorJobRequest : RpcAcsRequest<SubmitAIVideoCensorJobResponse>
    {
        public SubmitAIVideoCensorJobRequest()
            : base("vod", "2017-03-14", "SubmitAIVideoCensorJob", "vod", "openAPI")
        {
        ...
        public override SubmitAIVideoCensorJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
