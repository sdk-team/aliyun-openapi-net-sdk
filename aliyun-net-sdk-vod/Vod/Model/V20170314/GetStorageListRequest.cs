...
{
    public class GetStorageListRequest : RpcAcsRequest<GetStorageListResponse>
    {
        public GetStorageListRequest()
            : base("vod", "2017-03-14", "GetStorageList", "vod", "openAPI")
        {
		...
		public string StorageStatus
		{
			...
			{
				storageStatus = value;
				DictionaryUtil.Add(QueryParameters, "StorageStatus", value);
			}
		}
        ...
        public override GetStorageListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetStorageListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
