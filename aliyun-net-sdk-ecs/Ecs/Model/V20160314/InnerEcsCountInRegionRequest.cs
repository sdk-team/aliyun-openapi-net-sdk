...
{
    public class InnerEcsCountInRegionRequest : RpcAcsRequest<InnerEcsCountInRegionResponse>
    {
        public InnerEcsCountInRegionRequest()
            : base("Ecs", "2016-03-14", "InnerEcsCountInRegion", "ecs", "openAPI")
        {
        ...
        public override InnerEcsCountInRegionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerEcsCountInRegionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
