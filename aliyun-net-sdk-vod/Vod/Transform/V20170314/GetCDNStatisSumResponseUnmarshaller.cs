...
namespace Aliyun.Acs.vod.Transform.V20170314
{
    public class GetCDNStatisSumResponseUnmarshaller
    {
        public static GetCDNStatisSumResponse Unmarshall(UnmarshallerContext context)
        {
			...
			getCDNStatisSumResponse.Current95BpsDataValue = context.LongValue("GetCDNStatisSum.Current95BpsDataValue");
			getCDNStatisSumResponse.Level = context.StringValue("GetCDNStatisSum.Level");
			...
			for (int i = 0; i < context.Length("GetCDNStatisSum.CDNStatisList.Length"); i++) {
				...
				cDNMetric.StatTimeUTC = context.StringValue("GetCDNStatisSum.CDNStatisList["+ i +"].StatTimeUTC");
