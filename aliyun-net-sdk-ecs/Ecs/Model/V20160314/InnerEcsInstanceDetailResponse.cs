...
{
	public class InnerEcsInstanceDetailResponse : AcsResponse
	{

		private string requestId;

		private InnerEcsInstanceDetail_ErrorCode errorCode;

		private InnerEcsInstanceDetail_Data data;
		...
		public InnerEcsInstanceDetail_ErrorCode ErrorCode
		{
			get
			{
				return errorCode;
		...
		public InnerEcsInstanceDetail_Data Data
		{
			get
			{
				return data;
		...
		public class InnerEcsInstanceDetail_ErrorCode
		{
		...
		public class InnerEcsInstanceDetail_Data
		{
			...
			private List<InnerEcsInstanceDetail_Tag> tags;

			private List<InnerEcsInstanceDetail_Group> groups;

			private InnerEcsInstanceDetail_PublicIp publicIp;

			private InnerEcsInstanceDetail_Img img;
			...
			public List<InnerEcsInstanceDetail_Tag> Tags
			{
				get
				{
					return tags;
			...
			public List<InnerEcsInstanceDetail_Group> Groups
			{
				get
				{
					return groups;
			...
			public InnerEcsInstanceDetail_PublicIp PublicIp
			{
				get
				{
					return publicIp;
			...
			public InnerEcsInstanceDetail_Img Img
			{
				get
				{
					return img;
			...
			public class InnerEcsInstanceDetail_Tag
			{
			...
			public class InnerEcsInstanceDetail_Group
			{
			...
			public class InnerEcsInstanceDetail_PublicIp
			{
			...
			public class InnerEcsInstanceDetail_Img
			{
