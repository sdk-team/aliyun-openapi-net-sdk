...
{
    public class InnerCountEcsInRegionRequest : RpcAcsRequest<InnerCountEcsInRegionResponse>
    {
        public InnerCountEcsInRegionRequest()
            : base("Ecs", "2016-03-14", "InnerCountEcsInRegion", "ecs", "openAPI")
        {
        ...
        public override InnerCountEcsInRegionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerCountEcsInRegionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
