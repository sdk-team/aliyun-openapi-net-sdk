...
{
    public class SPILogicalDeleteResourceActionRequest : RpcAcsRequest<SPILogicalDeleteResourceActionResponse>
    {
        public SPILogicalDeleteResourceActionRequest()
            : base("vod", "2017-03-14", "SPILogicalDeleteResourceAction", "vod", "openAPI")
        {
        ...
        public override SPILogicalDeleteResourceActionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SPILogicalDeleteResourceActionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
