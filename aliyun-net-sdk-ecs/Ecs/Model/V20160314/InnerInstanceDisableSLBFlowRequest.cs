...
{
    public class InnerInstanceDisableSLBFlowRequest : RpcAcsRequest<InnerInstanceDisableSLBFlowResponse>
    {
        public InnerInstanceDisableSLBFlowRequest()
            : base("Ecs", "2016-03-14", "InnerInstanceDisableSLBFlow", "ecs", "openAPI")
        {
        ...
        public override InnerInstanceDisableSLBFlowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerInstanceDisableSLBFlowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
