...
namespace Aliyun.Acs.Iot.Model.V20190730
{
    public class QueryStandardUnitRequest : RpcAcsRequest<QueryStandardUnitResponse>
    {
        public QueryStandardUnitRequest()
            : base("Iot", "2019-07-30", "QueryStandardUnit")
        {
        }
        ...
        public override QueryStandardUnitResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryStandardUnitResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
