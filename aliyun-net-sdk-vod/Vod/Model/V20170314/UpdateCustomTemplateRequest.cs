...
{
    public class UpdateCustomTemplateRequest : RpcAcsRequest<UpdateCustomTemplateResponse>
    {
        public UpdateCustomTemplateRequest()
            : base("vod", "2017-03-14", "UpdateCustomTemplate", "vod", "openAPI")
        {
        ...
        public override UpdateCustomTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateCustomTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
