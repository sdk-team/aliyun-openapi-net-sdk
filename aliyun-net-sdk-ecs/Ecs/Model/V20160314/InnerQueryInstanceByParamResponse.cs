...
{
	public class InnerQueryInstanceByParamResponse : AcsResponse
	{
		...
		private List<InnerQueryInstanceByParam_InstanceAsyncModel> instanceAsyncModels;
		...
		public List<InnerQueryInstanceByParam_InstanceAsyncModel> InstanceAsyncModels
		{
			get
			{
				return instanceAsyncModels;
			}
			set	
			{
				instanceAsyncModels = value;
			}
		}

		public class InnerQueryInstanceByParam_InstanceAsyncModel
		{
			...
			private InnerQueryInstanceByParam_Zone zone;

			private InnerQueryInstanceByParam_Iz iz;

			private InnerQueryInstanceByParam_Region region;
			...
			public InnerQueryInstanceByParam_Zone Zone
			{
				get
				{
					return zone;
			...
			public InnerQueryInstanceByParam_Iz Iz
			{
				get
				{
					return iz;
			...
			public InnerQueryInstanceByParam_Region Region
			{
				get
				{
					return region;
			...
			public class InnerQueryInstanceByParam_Zone
			{
			...
			public class InnerQueryInstanceByParam_Iz
			{
				...
				private List<InnerQueryInstanceByParam_IzResourceMode> izResourceModel;
				...
				public List<InnerQueryInstanceByParam_IzResourceMode> IzResourceModel
				{
					get
					{
				...
				public class InnerQueryInstanceByParam_IzResourceMode
				{
			...
			public class InnerQueryInstanceByParam_Region
			{
