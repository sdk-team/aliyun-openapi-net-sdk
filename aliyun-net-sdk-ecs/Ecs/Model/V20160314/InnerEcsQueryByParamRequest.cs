...
{
    public class InnerEcsQueryByParamRequest : RpcAcsRequest<InnerEcsQueryByParamResponse>
    {
        public InnerEcsQueryByParamRequest()
            : base("Ecs", "2016-03-14", "InnerEcsQueryByParam", "ecs", "openAPI")
        {
        ...
        public override InnerEcsQueryByParamResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerEcsQueryByParamResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
