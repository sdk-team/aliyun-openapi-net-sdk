...
namespace Aliyun.Acs.vod.Model.V20170314
{
    public class SetDefaultVodTemplateRequest : RpcAcsRequest<SetDefaultVodTemplateResponse>
    {
        public SetDefaultVodTemplateRequest()
            : base("vod", "2017-03-14", "SetDefaultVodTemplate", "vod", "openAPI")
        {
        ...
        public override SetDefaultVodTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
