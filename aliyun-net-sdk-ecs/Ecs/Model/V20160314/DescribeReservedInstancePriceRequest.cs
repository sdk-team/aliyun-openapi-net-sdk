...
{
    public class DescribeReservedInstancePriceRequest : RpcAcsRequest<DescribeReservedInstancePriceResponse>
    {
        public DescribeReservedInstancePriceRequest()
            : base("Ecs", "2016-03-14", "DescribeReservedInstancePrice", "ecs", "openAPI")
        {
        ...
        public override DescribeReservedInstancePriceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeReservedInstancePriceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
