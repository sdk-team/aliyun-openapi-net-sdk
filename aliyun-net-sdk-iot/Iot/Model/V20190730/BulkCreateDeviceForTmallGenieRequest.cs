...
namespace Aliyun.Acs.Iot.Model.V20190730
{
    public class BulkCreateDeviceForTmallGenieRequest : RpcAcsRequest<BulkCreateDeviceForTmallGenieResponse>
    {
        public BulkCreateDeviceForTmallGenieRequest()
            : base("Iot", "2019-07-30", "BulkCreateDeviceForTmallGenie")
        {
        }
        ...
        public override BulkCreateDeviceForTmallGenieResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BulkCreateDeviceForTmallGenieResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
