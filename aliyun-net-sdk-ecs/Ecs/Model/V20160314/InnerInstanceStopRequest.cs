...
{
    public class InnerInstanceStopRequest : RpcAcsRequest<InnerInstanceStopResponse>
    {
        public InnerInstanceStopRequest()
            : base("Ecs", "2016-03-14", "InnerInstanceStop", "ecs", "openAPI")
        {
        ...
        public override InnerInstanceStopResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerInstanceStopResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
