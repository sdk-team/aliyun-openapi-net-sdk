...
{
    public class InnerGroupRemoveRequest : RpcAcsRequest<InnerGroupRemoveResponse>
    {
        public InnerGroupRemoveRequest()
            : base("Ecs", "2016-03-14", "InnerGroupRemove", "ecs", "openAPI")
        {
        ...
        public override InnerGroupRemoveResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerGroupRemoveResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
