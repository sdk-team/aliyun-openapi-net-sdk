...
namespace Aliyun.Acs.Rds.Model.V20140815
{
    public class DescribeCustinsKernelReleaseNotesRequest : RpcAcsRequest<DescribeCustinsKernelReleaseNotesResponse>
    {
        public DescribeCustinsKernelReleaseNotesRequest()
            : base("Rds", "2014-08-15", "DescribeCustinsKernelReleaseNotes")
        {
        }
        ...
        public override DescribeCustinsKernelReleaseNotesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
