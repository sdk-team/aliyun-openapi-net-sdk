...
{
    public class InnerSnapshotDescribeMountedSnapshotsRequest : RpcAcsRequest<InnerSnapshotDescribeMountedSnapshotsResponse>
    {
        public InnerSnapshotDescribeMountedSnapshotsRequest()
            : base("Ecs", "2016-03-14", "InnerSnapshotDescribeMountedSnapshots", "ecs", "openAPI")
        {
        ...
        public override InnerSnapshotDescribeMountedSnapshotsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerSnapshotDescribeMountedSnapshotsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
