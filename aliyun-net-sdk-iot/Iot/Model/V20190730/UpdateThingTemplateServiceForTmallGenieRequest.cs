...
namespace Aliyun.Acs.Iot.Model.V20190730
{
    public class UpdateThingTemplateServiceForTmallGenieRequest : RpcAcsRequest<UpdateThingTemplateServiceForTmallGenieResponse>
    {
        public UpdateThingTemplateServiceForTmallGenieRequest()
            : base("Iot", "2019-07-30", "UpdateThingTemplateServiceForTmallGenie")
        {
        }
        ...
        public override UpdateThingTemplateServiceForTmallGenieResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateThingTemplateServiceForTmallGenieResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
