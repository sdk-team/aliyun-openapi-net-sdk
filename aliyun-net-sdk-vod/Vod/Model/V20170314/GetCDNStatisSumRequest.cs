...
namespace Aliyun.Acs.vod.Model.V20170314
{
    public class GetCDNStatisSumRequest : RpcAcsRequest<GetCDNStatisSumResponse>
    {
        public GetCDNStatisSumRequest()
            : base("vod", "2017-03-14", "GetCDNStatisSum", "vod", "openAPI")
        {
		...
		public string LevelRule
		{
			...
			{
				levelRule = value;
				DictionaryUtil.Add(QueryParameters, "LevelRule", value);
			}
		}
        ...
        public override GetCDNStatisSumResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
