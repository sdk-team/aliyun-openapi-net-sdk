    ...
    public class SearchEditingProjectResponseUnmarshaller
    {
        public static SearchEditingProjectResponse Unmarshall(UnmarshallerContext context)
        {
			...
			for (int i = 0; i < context.Length("SearchEditingProject.ProjectList.Length"); i++) {
				...
				project.CreateTime = context.StringValue("SearchEditingProject.ProjectList["+ i +"].CreateTime");
				project.ModifyTime = context.StringValue("SearchEditingProject.ProjectList["+ i +"].ModifyTime");
				project.CustomerId = context.StringValue("SearchEditingProject.ProjectList["+ i +"].CustomerId");
				...
				project.ProducedMediaId = context.StringValue("SearchEditingProject.ProjectList["+ i +"].ProducedMediaId");
