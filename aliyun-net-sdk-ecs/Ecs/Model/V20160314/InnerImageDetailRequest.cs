...
{
    public class InnerImageDetailRequest : RpcAcsRequest<InnerImageDetailResponse>
    {
        public InnerImageDetailRequest()
            : base("Ecs", "2016-03-14", "InnerImageDetail", "ecs", "openAPI")
        {
		...
		public bool? IncludeDeleted
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "includeDeleted", value.ToString());
			}
		}
        ...
        public override InnerImageDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerImageDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
