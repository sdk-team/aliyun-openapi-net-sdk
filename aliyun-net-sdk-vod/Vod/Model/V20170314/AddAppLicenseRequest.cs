...
{
    public class AddAppLicenseRequest : RpcAcsRequest<AddAppLicenseResponse>
    {
        public AddAppLicenseRequest()
            : base("vod", "2017-03-14", "AddAppLicense", "vod", "openAPI")
        {
        ...
        public override AddAppLicenseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddAppLicenseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
