...
namespace Aliyun.Acs.vod.Model.V20170314
{
    public class SubmitAIVideoTerrorismRecogJobRequest : RpcAcsRequest<SubmitAIVideoTerrorismRecogJobResponse>
    {
        public SubmitAIVideoTerrorismRecogJobRequest()
            : base("vod", "2017-03-14", "SubmitAIVideoTerrorismRecogJob", "vod", "openAPI")
        {
        ...
        public override SubmitAIVideoTerrorismRecogJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
