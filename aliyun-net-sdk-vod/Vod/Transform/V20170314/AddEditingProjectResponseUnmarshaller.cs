...
namespace Aliyun.Acs.vod.Transform.V20170314
{
    public class AddEditingProjectResponseUnmarshaller
    {
        public static AddEditingProjectResponse Unmarshall(UnmarshallerContext context)
        {
			...
			project.CreateTime = context.StringValue("AddEditingProject.Project.CreateTime");
			project.ModifyTime = context.StringValue("AddEditingProject.Project.ModifyTime");
			project.CustomerId = context.StringValue("AddEditingProject.Project.CustomerId");
