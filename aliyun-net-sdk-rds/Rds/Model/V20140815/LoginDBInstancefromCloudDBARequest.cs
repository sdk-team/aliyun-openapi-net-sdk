...
namespace Aliyun.Acs.Rds.Model.V20140815
{
    public class LoginDBInstancefromCloudDBARequest : RpcAcsRequest<LoginDBInstancefromCloudDBAResponse>
    {
        public LoginDBInstancefromCloudDBARequest()
            : base("Rds", "2014-08-15", "LoginDBInstancefromCloudDBA")
        {
        }
        ...
        public override LoginDBInstancefromCloudDBAResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
