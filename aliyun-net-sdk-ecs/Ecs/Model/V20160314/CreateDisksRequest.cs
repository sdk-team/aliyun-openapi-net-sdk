...
{
    public class CreateDisksRequest : RpcAcsRequest<CreateDisksResponse>
    {
        public CreateDisksRequest()
            : base("Ecs", "2016-03-14", "CreateDisks", "ecs", "openAPI")
        {
		...
		public string Encrypted
		{
			...
			{
				encrypted = value;
				DictionaryUtil.Add(QueryParameters, "Encrypted", value);
			}
		}
        ...
        public override CreateDisksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateDisksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
