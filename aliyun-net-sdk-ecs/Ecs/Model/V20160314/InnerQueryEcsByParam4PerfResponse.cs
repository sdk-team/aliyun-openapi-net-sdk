...
{
	public class InnerQueryEcsByParam4PerfResponse : AcsResponse
	{
		...
		private List<InnerQueryEcsByParam4Perf_EcsInstance> ecsInstances;
		...
		public List<InnerQueryEcsByParam4Perf_EcsInstance> EcsInstances
		{
			get
			{
				return ecsInstances;
		...
		public class InnerQueryEcsByParam4Perf_EcsInstance
		{
			...
			private InnerQueryEcsByParam4Perf_Region region;

			private InnerQueryEcsByParam4Perf_Iz iz;

			private InnerQueryEcsByParam4Perf_Zone zone;
			...
			public InnerQueryEcsByParam4Perf_Region Region
			{
				get
				{
					return region;
			...
			public InnerQueryEcsByParam4Perf_Iz Iz
			{
				get
				{
					return iz;
			...
			public InnerQueryEcsByParam4Perf_Zone Zone
			{
				get
				{
					return zone;
			...
			public class InnerQueryEcsByParam4Perf_Region
			{
				...
				private InnerQueryEcsByParam4Perf_Attributes attributes;
				...
				public InnerQueryEcsByParam4Perf_Attributes Attributes
				{
					get
					{
						return attributes;
				...
				public class InnerQueryEcsByParam4Perf_Attributes
				{
			...
			public class InnerQueryEcsByParam4Perf_Iz
			{
				...
				private List<InnerQueryEcsByParam4Perf_IzResourceMode> izResourceModel;
				...
				public List<InnerQueryEcsByParam4Perf_IzResourceMode> IzResourceModel
				{
					get
					{
				...
				public class InnerQueryEcsByParam4Perf_IzResourceMode
				{
			...
			public class InnerQueryEcsByParam4Perf_Zone
			{
