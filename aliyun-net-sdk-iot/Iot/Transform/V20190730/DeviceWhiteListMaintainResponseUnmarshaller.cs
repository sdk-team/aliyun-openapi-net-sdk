...
namespace Aliyun.Acs.Iot.Transform.V20190730
{
    ...
    {
        public static DeviceWhiteListMaintainResponse Unmarshall(UnmarshallerContext context)
        {
			DeviceWhiteListMaintainResponse deviceWhiteListMaintainResponse = new DeviceWhiteListMaintainResponse();

			deviceWhiteListMaintainResponse.HttpResponse = context.HttpResponse;
			deviceWhiteListMaintainResponse.RequestId = context.StringValue("DeviceWhiteListMaintain.RequestId");
