...
namespace Aliyun.Acs.Iot.Transform.V20190730
{
    ...
    {
        public static CreateProductForTmallGenieResponse Unmarshall(UnmarshallerContext context)
        {
			CreateProductForTmallGenieResponse createProductForTmallGenieResponse = new CreateProductForTmallGenieResponse();

			createProductForTmallGenieResponse.HttpResponse = context.HttpResponse;
			createProductForTmallGenieResponse.RequestId = context.StringValue("CreateProductForTmallGenie.RequestId");
			createProductForTmallGenieResponse.Success = context.BooleanValue("CreateProductForTmallGenie.Success");
