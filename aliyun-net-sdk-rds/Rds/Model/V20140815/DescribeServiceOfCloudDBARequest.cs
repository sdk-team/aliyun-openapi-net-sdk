...
{
    public class DescribeServiceOfCloudDBARequest : RpcAcsRequest<DescribeServiceOfCloudDBAResponse>
    {
        public DescribeServiceOfCloudDBARequest()
            : base("Rds", "2014-08-15", "DescribeServiceOfCloudDBA")
        {
        }
        ...
        public override DescribeServiceOfCloudDBAResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeServiceOfCloudDBAResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
