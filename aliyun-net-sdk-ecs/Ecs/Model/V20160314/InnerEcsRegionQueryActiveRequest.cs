...
{
    public class InnerEcsRegionQueryActiveRequest : RpcAcsRequest<InnerEcsRegionQueryActiveResponse>
    {
        public InnerEcsRegionQueryActiveRequest()
            : base("Ecs", "2016-03-14", "InnerEcsRegionQueryActive", "ecs", "openAPI")
        {
        ...
        public override InnerEcsRegionQueryActiveResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerEcsRegionQueryActiveResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
