...
{
    public class InnerMonitorDataDescribeDiskRequest : RpcAcsRequest<InnerMonitorDataDescribeDiskResponse>
    {
        public InnerMonitorDataDescribeDiskRequest()
            : base("Ecs", "2016-03-14", "InnerMonitorDataDescribeDisk", "ecs", "openAPI")
        {
        ...
        public override InnerMonitorDataDescribeDiskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerMonitorDataDescribeDiskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
