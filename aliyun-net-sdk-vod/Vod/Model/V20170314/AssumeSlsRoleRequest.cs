...
{
    public class AssumeSlsRoleRequest : RpcAcsRequest<AssumeSlsRoleResponse>
    {
        public AssumeSlsRoleRequest()
            : base("vod", "2017-03-14", "AssumeSlsRole", "vod", "openAPI")
        {
        ...
        public override AssumeSlsRoleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AssumeSlsRoleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
