...
{
    public class SPICheckResourceActionRequest : RpcAcsRequest<SPICheckResourceActionResponse>
    {
        public SPICheckResourceActionRequest()
            : base("vod", "2017-03-14", "SPICheckResourceAction", "vod", "openAPI")
        {
        ...
        public override SPICheckResourceActionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SPICheckResourceActionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
