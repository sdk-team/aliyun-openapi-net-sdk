...
{
	public class InnerEcsQueryByParam4PerfResponse : AcsResponse
	{
		...
		private List<InnerEcsQueryByParam4Perf_Item> data;

		private InnerEcsQueryByParam4Perf_ErrorCode errorCode;
		...
		public List<InnerEcsQueryByParam4Perf_Item> Data
		{
			get
			{
				return data;
		...
		public InnerEcsQueryByParam4Perf_ErrorCode ErrorCode
		{
			get
			{
				return errorCode;
		...
		public class InnerEcsQueryByParam4Perf_Item
		{
			...
			private InnerEcsQueryByParam4Perf_Region region;

			private InnerEcsQueryByParam4Perf_Iz iz;

			private InnerEcsQueryByParam4Perf_Zone zone;
			...
			public InnerEcsQueryByParam4Perf_Region Region
			{
				get
				{
					return region;
			...
			public InnerEcsQueryByParam4Perf_Iz Iz
			{
				get
				{
					return iz;
			...
			public InnerEcsQueryByParam4Perf_Zone Zone
			{
				get
				{
					return zone;
			...
			public class InnerEcsQueryByParam4Perf_Region
			{
				...
				private InnerEcsQueryByParam4Perf_Attributes attributes;
				...
				public InnerEcsQueryByParam4Perf_Attributes Attributes
				{
					get
					{
						return attributes;
				...
				public class InnerEcsQueryByParam4Perf_Attributes
				{
			...
			public class InnerEcsQueryByParam4Perf_Iz
			{
				...
				private List<InnerEcsQueryByParam4Perf_IzResourceModelItem> izResourceModel;
				...
				public List<InnerEcsQueryByParam4Perf_IzResourceModelItem> IzResourceModel
				{
					get
					{
				...
				public class InnerEcsQueryByParam4Perf_IzResourceModelItem
				{
			...
			public class InnerEcsQueryByParam4Perf_Zone
			{
		...
		public class InnerEcsQueryByParam4Perf_ErrorCode
		{
