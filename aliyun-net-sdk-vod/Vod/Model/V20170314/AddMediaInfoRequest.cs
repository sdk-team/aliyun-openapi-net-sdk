...
{
    public class AddMediaInfoRequest : RpcAcsRequest<AddMediaInfoResponse>
    {
        public AddMediaInfoRequest()
            : base("vod", "2017-03-14", "AddMediaInfo", "vod", "openAPI")
        {
		...
		public string MediaWorkflowRunId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "MediaWorkflowRunId", value);
			}
		}
		...
		public int? Privilege
		{
			...
			{
				privilege = value;
				DictionaryUtil.Add(QueryParameters, "Privilege", value.ToString());
			}
		}
		...
		public string FileMd5
		{
			...
			{
				fileMd5 = value;
				DictionaryUtil.Add(QueryParameters, "FileMd5", value);
			}
		}
        ...
        public override AddMediaInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddMediaInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
