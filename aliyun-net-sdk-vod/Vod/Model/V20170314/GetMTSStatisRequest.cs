...
{
    public class GetMTSStatisRequest : RpcAcsRequest<GetMTSStatisResponse>
    {
        public GetMTSStatisRequest()
            : base("vod", "2017-03-14", "GetMTSStatis", "vod", "openAPI")
        {
        ...
        public override GetMTSStatisResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetMTSStatisResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
