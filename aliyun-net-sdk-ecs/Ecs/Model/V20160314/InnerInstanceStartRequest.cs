...
{
    public class InnerInstanceStartRequest : RpcAcsRequest<InnerInstanceStartResponse>
    {
        public InnerInstanceStartRequest()
            : base("Ecs", "2016-03-14", "InnerInstanceStart", "ecs", "openAPI")
        {
        ...
        public override InnerInstanceStartResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerInstanceStartResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
