...
{
    public class InnerMaliceEcsLockRequest : RpcAcsRequest<InnerMaliceEcsLockResponse>
    {
        public InnerMaliceEcsLockRequest()
            : base("Ecs", "2016-03-14", "InnerMaliceEcsLock", "ecs", "openAPI")
        {
        ...
        public override InnerMaliceEcsLockResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerMaliceEcsLockResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
