...
namespace Aliyun.Acs.Iot.Model.V20190730
{
    public class DataCleanSyncDeviceBindRequest : RpcAcsRequest<DataCleanSyncDeviceBindResponse>
    {
        public DataCleanSyncDeviceBindRequest()
            : base("Iot", "2019-07-30", "DataCleanSyncDeviceBind")
        {
        }
        ...
        public override DataCleanSyncDeviceBindResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DataCleanSyncDeviceBindResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
