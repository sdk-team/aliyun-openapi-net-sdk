...
{
    public class InnerGroupLeaveRequest : RpcAcsRequest<InnerGroupLeaveResponse>
    {
        public InnerGroupLeaveRequest()
            : base("Ecs", "2016-03-14", "InnerGroupLeave", "ecs", "openAPI")
        {
        ...
        public override InnerGroupLeaveResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerGroupLeaveResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
