...
{
	public class InnerEcsQueryByIpResponse : AcsResponse
	{
		...
		private List<InnerEcsQueryByIp_Item> data;

		private InnerEcsQueryByIp_ErrorCode errorCode;
		...
		public List<InnerEcsQueryByIp_Item> Data
		{
			get
			{
				return data;
		...
		public InnerEcsQueryByIp_ErrorCode ErrorCode
		{
			get
			{
				return errorCode;
		...
		public class InnerEcsQueryByIp_Item
		{
			...
			private InnerEcsQueryByIp_Region region;

			private InnerEcsQueryByIp_Iz iz;

			private InnerEcsQueryByIp_Zone zone;
			...
			public InnerEcsQueryByIp_Region Region
			{
				get
				{
					return region;
			...
			public InnerEcsQueryByIp_Iz Iz
			{
				get
				{
					return iz;
			...
			public InnerEcsQueryByIp_Zone Zone
			{
				get
				{
					return zone;
			...
			public class InnerEcsQueryByIp_Region
			{
				...
				private InnerEcsQueryByIp_Attributes attributes;
				...
				public InnerEcsQueryByIp_Attributes Attributes
				{
					get
					{
						return attributes;
				...
				public class InnerEcsQueryByIp_Attributes
				{
			...
			public class InnerEcsQueryByIp_Iz
			{
				...
				private List<InnerEcsQueryByIp_IzResourceModelItem> izResourceModel;
				...
				public List<InnerEcsQueryByIp_IzResourceModelItem> IzResourceModel
				{
					get
					{
				...
				public class InnerEcsQueryByIp_IzResourceModelItem
				{
			...
			public class InnerEcsQueryByIp_Zone
			{
		...
		public class InnerEcsQueryByIp_ErrorCode
		{
