...
{
    public class InnerQueryEcsByIpRequest : RpcAcsRequest<InnerQueryEcsByIpResponse>
    {
        public InnerQueryEcsByIpRequest()
            : base("Ecs", "2016-03-14", "InnerQueryEcsByIp", "ecs", "openAPI")
        {
        ...
        public override InnerQueryEcsByIpResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerQueryEcsByIpResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
