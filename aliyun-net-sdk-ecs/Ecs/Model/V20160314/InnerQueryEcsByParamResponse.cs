...
{
	public class InnerQueryEcsByParamResponse : AcsResponse
	{
		...
		private List<InnerQueryEcsByParam_EcsInstance> ecsInstances;
		...
		public List<InnerQueryEcsByParam_EcsInstance> EcsInstances
		{
			get
			{
				return ecsInstances;
		...
		public class InnerQueryEcsByParam_EcsInstance
		{
			...
			private InnerQueryEcsByParam_Region region;

			private InnerQueryEcsByParam_Iz iz;

			private InnerQueryEcsByParam_Zone zone;
			...
			public InnerQueryEcsByParam_Region Region
			{
				get
				{
					return region;
			...
			public InnerQueryEcsByParam_Iz Iz
			{
				get
				{
					return iz;
			...
			public InnerQueryEcsByParam_Zone Zone
			{
				get
				{
					return zone;
			...
			public class InnerQueryEcsByParam_Region
			{
				...
				private InnerQueryEcsByParam_Attributes attributes;
				...
				public InnerQueryEcsByParam_Attributes Attributes
				{
					get
					{
						return attributes;
				...
				public class InnerQueryEcsByParam_Attributes
				{
			...
			public class InnerQueryEcsByParam_Iz
			{
				...
				private List<InnerQueryEcsByParam_IzResourceMode> izResourceModel;
				...
				public List<InnerQueryEcsByParam_IzResourceMode> IzResourceModel
				{
					get
					{
				...
				public class InnerQueryEcsByParam_IzResourceMode
				{
			...
			public class InnerQueryEcsByParam_Zone
			{
