...
{
	public class GetCompanionresourceInfoResponse : AcsResponse
	{

		private string requestId;

		private GetCompanionresourceInfo_CompanionResourceInfo companionResourceInfo;
		...
		public GetCompanionresourceInfo_CompanionResourceInfo CompanionResourceInfo
		{
			get
			{
			...
			set	
			{
				companionResourceInfo = value;
			}
		}

		public class GetCompanionresourceInfo_CompanionResourceInfo
		{
