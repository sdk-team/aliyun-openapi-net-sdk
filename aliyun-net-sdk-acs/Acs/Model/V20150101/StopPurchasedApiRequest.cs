...
{
    public class StopPurchasedApiRequest : RoaAcsRequest<StopPurchasedApiResponse>
    {
        public StopPurchasedApiRequest()
            : base("Acs", "2015-01-01", "StopPurchasedApi", "12334", "openAPI")
        {
			UriPattern = "/Api/StopPurchasedApi";
        ...
        public override StopPurchasedApiResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopPurchasedApiResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
