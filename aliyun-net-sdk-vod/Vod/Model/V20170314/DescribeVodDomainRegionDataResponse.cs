...
{
	public class DescribeVodDomainRegionDataResponse : AcsResponse
	{
		...
		private List<DescribeVodDomainRegionData_RegionProportionData> _value;
		...
		public List<DescribeVodDomainRegionData_RegionProportionData> _Value
		{
			get
			{
				return _value;
		...
		public class DescribeVodDomainRegionData_RegionProportionData
		{
