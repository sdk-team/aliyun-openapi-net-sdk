...
{
    public class InnerEcsRenameRequest : RpcAcsRequest<InnerEcsRenameResponse>
    {
        public InnerEcsRenameRequest()
            : base("Ecs", "2016-03-14", "InnerEcsRename", "ecs", "openAPI")
        {
        ...
        public override InnerEcsRenameResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerEcsRenameResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
