...
{
    public class DeleteStorageRequest : RpcAcsRequest<DeleteStorageResponse>
    {
        public DeleteStorageRequest()
            : base("vod", "2017-03-14", "DeleteStorage", "vod", "openAPI")
        {
        ...
        public override DeleteStorageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteStorageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
