...
{
    public class InnerEcsInstanceDetailRequest : RpcAcsRequest<InnerEcsInstanceDetailResponse>
    {
        public InnerEcsInstanceDetailRequest()
            : base("Ecs", "2016-03-14", "InnerEcsInstanceDetail", "ecs", "openAPI")
        {
        ...
        public override InnerEcsInstanceDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerEcsInstanceDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
