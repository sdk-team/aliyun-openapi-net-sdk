...
{
    public class InnerGroupRevokeRequest : RpcAcsRequest<InnerGroupRevokeResponse>
    {
        public InnerGroupRevokeRequest()
            : base("Ecs", "2016-03-14", "InnerGroupRevoke", "ecs", "openAPI")
        {
        ...
        public override InnerGroupRevokeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerGroupRevokeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
