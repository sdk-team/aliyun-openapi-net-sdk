...
{
    public class InnerMaliceEcsUnlockRequest : RpcAcsRequest<InnerMaliceEcsUnlockResponse>
    {
        public InnerMaliceEcsUnlockRequest()
            : base("Ecs", "2016-03-14", "InnerMaliceEcsUnlock", "ecs", "openAPI")
        {
		...
		public string Proof
		{
			...
			{
				proof = value;
				DictionaryUtil.Add(QueryParameters, "proof", value);
			}
		}
		...
		public string LockType
		{
			...
			{
				lockType = value;
				DictionaryUtil.Add(QueryParameters, "lockType", value);
			}
		}
        ...
        public override InnerMaliceEcsUnlockResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerMaliceEcsUnlockResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
