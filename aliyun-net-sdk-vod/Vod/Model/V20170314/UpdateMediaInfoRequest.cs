...
{
    public class UpdateMediaInfoRequest : RpcAcsRequest<UpdateMediaInfoResponse>
    {
        public UpdateMediaInfoRequest()
            : base("vod", "2017-03-14", "UpdateMediaInfo", "vod", "openAPI")
        {
        ...
        public override UpdateMediaInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateMediaInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
