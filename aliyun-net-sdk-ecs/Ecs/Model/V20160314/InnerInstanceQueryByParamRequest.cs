...
{
    public class InnerInstanceQueryByParamRequest : RpcAcsRequest<InnerInstanceQueryByParamResponse>
    {
        public InnerInstanceQueryByParamRequest()
            : base("Ecs", "2016-03-14", "InnerInstanceQueryByParam", "ecs", "openAPI")
        {
        ...
        public override InnerInstanceQueryByParamResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerInstanceQueryByParamResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
