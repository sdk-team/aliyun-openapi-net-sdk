...
namespace Aliyun.Acs.Iot.Model.V20190730
{
    public class DeleteProductForTmallGenieRequest : RpcAcsRequest<DeleteProductForTmallGenieResponse>
    {
        public DeleteProductForTmallGenieRequest()
            : base("Iot", "2019-07-30", "DeleteProductForTmallGenie")
        {
        }
        ...
        public override DeleteProductForTmallGenieResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteProductForTmallGenieResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
