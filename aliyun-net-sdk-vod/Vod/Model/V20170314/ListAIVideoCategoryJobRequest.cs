...
namespace Aliyun.Acs.vod.Model.V20170314
{
    public class ListAIVideoCategoryJobRequest : RpcAcsRequest<ListAIVideoCategoryJobResponse>
    {
        public ListAIVideoCategoryJobRequest()
            : base("vod", "2017-03-14", "ListAIVideoCategoryJob", "vod", "openAPI")
        {
        ...
        public override ListAIVideoCategoryJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
