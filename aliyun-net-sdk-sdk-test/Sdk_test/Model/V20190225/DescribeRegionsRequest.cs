...
using Aliyun.Acs.sdk_test;
using Aliyun.Acs.sdk_test.Transform;
using Aliyun.Acs.sdk_test.Transform.V20190225;

namespace Aliyun.Acs.sdk_test.Model.V20190225
{
    public class DescribeRegionsRequest : RpcAcsRequest<DescribeRegionsResponse>
    {
        public DescribeRegionsRequest()
            : base("sdk-test", "2019-02-25", "DescribeRegions")
        {
