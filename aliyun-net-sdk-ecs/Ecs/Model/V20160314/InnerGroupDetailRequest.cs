...
{
    public class InnerGroupDetailRequest : RpcAcsRequest<InnerGroupDetailResponse>
    {
        public InnerGroupDetailRequest()
            : base("Ecs", "2016-03-14", "InnerGroupDetail", "ecs", "openAPI")
        {
        ...
        public override InnerGroupDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerGroupDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
