...
namespace Aliyun.Acs.Iot.Model.V20190730
{
    public class MigratePoolFunctionListRequest : RpcAcsRequest<MigratePoolFunctionListResponse>
    {
        public MigratePoolFunctionListRequest()
            : base("Iot", "2019-07-30", "MigratePoolFunctionList")
        {
        }
        ...
        public override MigratePoolFunctionListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return MigratePoolFunctionListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
