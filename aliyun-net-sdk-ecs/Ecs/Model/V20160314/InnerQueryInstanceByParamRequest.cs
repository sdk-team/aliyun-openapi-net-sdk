...
{
    public class InnerQueryInstanceByParamRequest : RpcAcsRequest<InnerQueryInstanceByParamResponse>
    {
        public InnerQueryInstanceByParamRequest()
            : base("Ecs", "2016-03-14", "InnerQueryInstanceByParam", "ecs", "openAPI")
        {
		...
		public string VSwitchInstanceId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "vSwitchInstanceId", value);
			}
		}
        ...
        public override InnerQueryInstanceByParamResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerQueryInstanceByParamResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
