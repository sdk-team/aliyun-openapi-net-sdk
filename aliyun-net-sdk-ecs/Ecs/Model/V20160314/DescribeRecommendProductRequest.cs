...
{
    public class DescribeRecommendProductRequest : RpcAcsRequest<DescribeRecommendProductResponse>
    {
        public DescribeRecommendProductRequest()
            : base("Ecs", "2016-03-14", "DescribeRecommendProduct", "ecs", "openAPI")
        {
        ...
        public override DescribeRecommendProductResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRecommendProductResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
