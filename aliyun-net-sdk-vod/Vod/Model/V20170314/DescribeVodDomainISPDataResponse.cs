...
{
	public class DescribeVodDomainISPDataResponse : AcsResponse
	{
		...
		private List<DescribeVodDomainISPData_ISPProportionData> _value;
		...
		public List<DescribeVodDomainISPData_ISPProportionData> _Value
		{
			get
			{
				return _value;
		...
		public class DescribeVodDomainISPData_ISPProportionData
		{
