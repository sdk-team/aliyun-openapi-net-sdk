...
{
    public class GetAIStatisRequest : RpcAcsRequest<GetAIStatisResponse>
    {
        public GetAIStatisRequest()
            : base("vod", "2017-03-14", "GetAIStatis", "vod", "openAPI")
        {
        ...
        public override GetAIStatisResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAIStatisResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
