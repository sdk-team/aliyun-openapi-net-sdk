...
{
    public class InnerImageQueryUserImagesRequest : RpcAcsRequest<InnerImageQueryUserImagesResponse>
    {
        public InnerImageQueryUserImagesRequest()
            : base("Ecs", "2016-03-14", "InnerImageQueryUserImages", "ecs", "openAPI")
        {
		...
		public string IsPublic
		{
			...
			{
				isPublic = value;
				DictionaryUtil.Add(QueryParameters, "isPublic", value);
			}
		}
		...
		public long? OsTypeId
		{
			...
			{
				osTypeId = value;
				DictionaryUtil.Add(QueryParameters, "osTypeId", value.ToString());
			}
		}
        ...
        public override InnerImageQueryUserImagesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerImageQueryUserImagesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
