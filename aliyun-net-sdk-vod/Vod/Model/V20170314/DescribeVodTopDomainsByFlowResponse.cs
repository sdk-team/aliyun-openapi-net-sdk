...
{
	public class DescribeVodTopDomainsByFlowResponse : AcsResponse
	{
		...
		private List<DescribeVodTopDomainsByFlow_TopDomain> topDomains;
		...
		public List<DescribeVodTopDomainsByFlow_TopDomain> TopDomains
		{
			get
			{
				return topDomains;
		...
		public class DescribeVodTopDomainsByFlow_TopDomain
		{
