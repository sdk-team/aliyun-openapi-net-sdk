...
{
    public class InnerDetailRequest : RpcAcsRequest<InnerDetailResponse>
    {
        public InnerDetailRequest()
            : base("Ecs", "2016-03-14", "InnerDetail", "ecs", "openAPI")
        {
        ...
        public override InnerDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InnerDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
