...
{
	public class RpcHsfServiceRouteMatchApiResponse : AcsResponse
	{
		...
		private List<RpcHsfServiceRouteMatchApi_ArrayItem> arrayValue;

		private List<RpcHsfServiceRouteMatchApi_L1ArrayItem> l1Array;

		private List<RpcHsfServiceRouteMatchApi_ArrayItem> nullArrayValue;

		private RpcHsfServiceRouteMatchApi_NullToEmptyStructValue nullToEmptyStructValue;

		private RpcHsfServiceRouteMatchApi_StructValue structValue;
		...
		public List<RpcHsfServiceRouteMatchApi_ArrayItem> ArrayValue
		{
			get
			{
				return arrayValue;
		...
		public List<RpcHsfServiceRouteMatchApi_L1ArrayItem> L1Array
		{
			get
			{
				return l1Array;
		...
		public List<RpcHsfServiceRouteMatchApi_ArrayItem> NullArrayValue
		{
			get
			{
		...
		public RpcHsfServiceRouteMatchApi_NullToEmptyStructValue NullToEmptyStructValue
		{
			get
			{
		...
		public RpcHsfServiceRouteMatchApi_StructValue StructValue
		{
			get
			{
				return structValue;
		...
		public class RpcHsfServiceRouteMatchApi_ArrayItem
		{
		...
		public class RpcHsfServiceRouteMatchApi_L1ArrayItem
		{

			private string l1Member1;

			private List<RpcHsfServiceRouteMatchApi_L2ArrayItem> l2Array;

			private RpcHsfServiceRouteMatchApi_L1Struct l1Struct;
			...
			public List<RpcHsfServiceRouteMatchApi_L2ArrayItem> L2Array
			{
				get
				{
					return l2Array;
			...
			public RpcHsfServiceRouteMatchApi_L1Struct L1Struct
			{
				get
				{
					return l1Struct;
			...
			public class RpcHsfServiceRouteMatchApi_L2ArrayItem
			{

				private string l2Member1;

				private List<RpcHsfServiceRouteMatchApi_L3ArrayItem> l3Array;
				...
				public List<RpcHsfServiceRouteMatchApi_L3ArrayItem> L3Array
				{
					get
					{
						return l3Array;
				...
				public class RpcHsfServiceRouteMatchApi_L3ArrayItem
				{
			...
			public class RpcHsfServiceRouteMatchApi_L1Struct
			{
		...
		public class RpcHsfServiceRouteMatchApi_NullToEmptyStructValue
		{
		...
		public class RpcHsfServiceRouteMatchApi_StructValue
		{
