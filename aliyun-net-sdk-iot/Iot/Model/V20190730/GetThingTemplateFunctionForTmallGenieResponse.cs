...
namespace Aliyun.Acs.Iot.Model.V20190730
{
	public class GetThingTemplateFunctionForTmallGenieResponse : AcsResponse
	{
		...
		private GetThingTemplateFunctionForTmallGenie_Data data;
		...
		public GetThingTemplateFunctionForTmallGenie_Data Data
		{
			get
			{
				return data;
		...
		public class GetThingTemplateFunctionForTmallGenie_Data
		{
			...
			private GetThingTemplateFunctionForTmallGenie_EventInfos eventInfos;
			...
			public GetThingTemplateFunctionForTmallGenie_EventInfos EventInfos
			{
				get
				{
					return eventInfos;
			...
			public class GetThingTemplateFunctionForTmallGenie_EventInfos
			{
